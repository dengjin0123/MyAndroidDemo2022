...
public class TitlePanel extends BasePanel {
    ...
    public void setTitleBackgroundColor(int resId) {
        View titleBg = this.findViewById(R.id.fl_title_root);
        titleBg.setBackgroundColor(resId);
    }
    ...
    public void setBackView(String str) {
        setBackView(R.mipmap.back_gray, str);
    }
    ...
    public void setBackView() {
        setBackView(R.mipmap.back_gray, null);
    }
